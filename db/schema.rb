...
ActiveRecord::Schema.define(version: 20170821141256) do
  ...
  create_table "knus", force: :cascade do |t|
    t.string "key"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.text "description_permission", default: "", null: false
  ...
  create_table "vote_comments", force: :cascade do |t|
    ...
    t.integer "user_id"
    t.datetime "deleted_at"
    t.index ["deleted_at"], name: "index_vote_comments_on_deleted_at"
    t.index ["link_id"], name: "index_vote_comments_on_link_id"
